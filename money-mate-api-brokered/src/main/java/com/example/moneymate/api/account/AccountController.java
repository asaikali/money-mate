...
public class AccountController {
    ...
    public AccountController(ObpClient obpClient, BrokeredObpTokenService brokeredObpTokenService) {
    ...
    public ResponseEntity<AccountCollectionResponse> getAccounts() {
        try {
            ...
            ObpAccountsResponse accountsResponse = obpClient.getAccounts(obpToken);
            ObpBanksResponse banksResponse = obpClient.getBanks(obpToken);
