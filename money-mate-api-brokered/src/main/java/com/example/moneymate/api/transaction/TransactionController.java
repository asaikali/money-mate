...
public class TransactionController {
    ...
    public TransactionController(ObpClient obpClient, BrokeredObpTokenService brokeredObpTokenService) {
    ...
    public ResponseEntity<TransactionCollectionResponse> getTransactions(@PathVariable String accountId) {
        try {
            ...
            var accountsResponse = obpClient.getAccounts(obpToken);
            ...
            if (account == null) {
                log.warn("Account {} not found for user {}", accountId, subject);
