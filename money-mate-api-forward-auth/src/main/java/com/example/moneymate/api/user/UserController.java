...
public class UserController {
    ...
    public UserController(ObpClient obpClient, ForwardedAuthorizationService forwardedAuthorizationService) {
    ...
    public ResponseEntity<UserResponse> getCurrentUser() {
        try {
            ...
            UserDetailsResponse obpUser = obpClient.getCurrentUser(bearerToken);

            var accounts = obpClient.getAccounts(bearerToken);
