...
public class TransactionController {
    ...
    public TransactionController(ObpClient obpClient, ForwardedAuthorizationService forwardedAuthorizationService) {
    ...
    public ResponseEntity<TransactionCollectionResponse> getTransactions(@PathVariable String accountId) {
        try {
            ...
            var accountsResponse = obpClient.getAccounts(bearerToken);
            ...
            if (account == null) {
                log.warn("Account {} not found for forwarded user context", accountId);
