...
public class SessionController {
    ...
    public SessionController(SessionTokenStore tokenStore) {
    ...
    public ResponseEntity<SessionResponse> createSession(
        ...
        // Phase 1: Accept any credentials (stubbed authentication)
        // In Phase 2, this will call OBP DirectLogin

        // Create session and generate MMAT token
        String token = tokenStore.create(credentials.username());
